...
func main() {
	...
	matrix[0] = []int{8, 02, 22, 97, 38, 15, 00, 40, 00, 75, 04, 05, 07, 78, 52, 12, 50, 77, 91, 8}
	matrix[1] = []int{49, 49, 99, 40, 17, 81, 18, 57, 60, 87, 17, 40, 98, 43, 69, 48, 04, 56, 62, 00}
	...
	matrix[7] = []int{67 26 20 68 02 62 12 20 95 63 94 39 63 08 40 91 66 49 94 21}
	matrix[8] = []int{24 55 58 05 66 73 99 26 97 17 78 78 96 83 14 88 34 89 63 72}
	matrix[9] = []int{21 36 23 09 75 00 76 44 20 45 35 14 00 61 33 97 34 31 33 95}
	matrix[10] = []int{78 17 53 28 22 75 31 67 15 94 03 80 04 62 16 14 09 53 56 92}
	matrix[11] = []int{16 39 05 42 96 35 31 47 55 58 88 24 00 17 54 24 36 29 85 57}
	matrix[12] = []int{86 56 00 48 35 71 89 07 05 44 44 37 44 60 21 58 51 54 17 58}
	matrix[13] = []int{19 80 81 68 05 94 47 69 28 73 92 13 86 52 17 77 04 89 55 40}
	matrix[14] = []int{04 52 08 83 97 35 99 16 07 97 57 32 16 26 26 79 33 27 98 66}
	matrix[15] = []int{88 36 68 87 57 62 20 72 03 46 33 67 46 55 12 32 63 93 53 69}
	matrix[16] = []int{04 42 16 73 38 25 39 11 24 94 72 18 08 46 29 32 40 62 76 36}
